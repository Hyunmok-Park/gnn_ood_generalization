...
def main(index, seed):
  ...
  std_b_A = 0.25
  num_graphs_train = 9
  save_dir = '/home/ubuntu/TorchGNN_project/data_temp/exp1_test/test_{}/new_16'.format(std_J_A)
 ...
 # 'complete'
  ...
  for iii, tt in enumerate(topology_list):
      print(tt)
      try:
...
if __name__ == '__main__':
    ...
    p = Pool(processes=10)
    p.starmap(main, zip([i for i in range(10)], [i for i in range(10)]))
