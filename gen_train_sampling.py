...
# def main(group_index, index, split_num, tt_list, name_list, seed_list):
  ...
  J_list = pickle.load(open("data_temp/unique_graph_100/group_two_unimodal_train_{}.p".format(try_num), "rb"))['J_list']
  name_list_full = pickle.load(open("data_temp/unique_graph_100/group_two_unimodal_train_{}.p".format(try_num), "rb"))['name_list']
  ...
  for tt, seed, name in zip(tt_list, seed_list, name_list):
      ...
      file_name = os.path.join(save_dir, 'train', 'graph_{}_nn{}_{:07d}.p'.format(name, num_nodes_I, seed))
